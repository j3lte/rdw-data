...
Deno (from [JSR](https://jsr.io/@j3lte/rdw-data)):

```bash
deno add jsr:@j3lte/rdw-data
```

Node:

```bash
> npm install rdw-data
```
...
These are auto generated providers and use `soda-query@0.5.0`.
...
| `Gebieden1`                                 | [Gebieden](https://opendata.rdw.nl/Parkeren/Gebieden/b2fs-9ymw)                                                                                                    | Parkeren          |
| `Gebieden2`                                 | [Gebieden](https://opendata.rdw.nl/Parkeren/Gebieden/u3zx-f5hd)                                                                                                    | Parkeren          |
...
| `Locaties1`                                 | [Locaties](https://opendata.rdw.nl/Parkeren/Locaties/3rhp-hrx5)                                                                                                    | Parkeren          |
| `Locaties2`                                 | [Locaties](https://opendata.rdw.nl/Parkeren/Locaties/gfb5-nkdy)                                                                                                    | Parkeren          |
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/BrandstoffenOpPc4)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ErkendeBedrijven)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/Erkenningen)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/Gebreken)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/GeconstateerdeGebreken)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/GeoCarpool)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/GeoParkeerGarages)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/GeoPenr)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/KentekenVoertuigen)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/KentekenVoertuigenAssen)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/KentekenVoertuigenBijzonderheden)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/KentekenVoertuigenBrandstof)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/KentekenVoertuigenCarrosserie)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/KentekenVoertuigenCarrosserieSpecificatie)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/KentekenVoertuigenRupsbanden)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/KentekenVoertuigenSubcategorieVoertuig)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/KentekenVoertuigenVoertuigklasse)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/Keuringen)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/MeldingenKeuringsinstantie)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenBetaalmethodeGebied)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenBetaalmethodeVerkooppunt)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenContactpersoon)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenGebied)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenGebiedRegeling)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenGebiedsbeheerder)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenGebruiksdoel)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenGeldigheidsinperking)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenGeldigheidsuitbreiding)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenGeometrieGebied)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenGeoVerkooppunt)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenGpsCoordinatenParkeerlocatie)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenIndexStatischEnDynamisch)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenInUitgang)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenParkeeradres)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenParkeergebied)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenParkeergebiedContactpersoon)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenParkingOpen)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenParkingToegang)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenRegeling)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenSpecialeDag)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenSpecificatiesParkeergebied)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenTariefberekening)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenTariefdeel)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenTijdvak)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ParkerenVerkooppunt)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ProductenCatalogus)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TellerstandoordeelTrendToelichting)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TerugroepActie)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TerugroepActieRisico)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TerugroepActieStatus)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TerugroepInformerenEigenaar)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TerugroepVoertuigMerkType)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkAandrijvingUitvoering)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkAsUitvoering)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkBasisUitvoering)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkCarrosserieUitvoering)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkEnergiebronUitvoering)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkHandelsbenamingFabrikant)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkIntrekkingTypegoedkeuring)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkKoppelingUitvoering)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkMerkUitvoering)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkRupsbandsetUitvoering)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkSpecialeDoeleinden)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/TgkVersnellingUitvoering)
...
Documentation can be found [here](https://jsr.io/@j3lte/rdw-data/doc/~/ToegevoegdeObjecten)
