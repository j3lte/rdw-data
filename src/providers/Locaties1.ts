...
// Published: 2019-07-30T06:03:59.000Z
 ...
 */
export interface Locaties1_ResponseData {
  /**
   * ### 01_NAAM
   *
   * **Type**: Text
...
/**
 * Dataset metadata for **Locaties1**: the available field names, the
...
export const Info = {
  ...
  publication_date: "2019-07-30T06:03:59.000Z",
...
export const RDWQuery = (
  auth: AuthOpts = {},
  opts: Options = {},
): SodaQuery<Locaties1_ResponseData> =>
  createQueryWithDataset<Locaties1_ResponseData>(Info.domain, Info.dataset, auth, {
    ...opts,
 ...
 * - {@link Locaties1.RDWQuery} — a typed {@link SodaQuery} builder
 * - {@link Locaties1.Fields} — the queryable field definitions
 * - {@link Locaties1.Info} — dataset metadata
 *
 * **Category:** Parkeren
 *
 * **Tags:** parkeren
 ...
 * @example
 * ```ts
 * const { data } = await Locaties1.RDWQuery()
 *   .where(Where.like(Locaties1.Fields.N01Naam, "some_value"))
 *   .limit(10)
 *   .execute();
 * ```
 */
export const Locaties1 = {
  RDWQuery,
  Fields,
  Info,
};
