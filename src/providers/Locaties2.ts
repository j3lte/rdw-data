...
// Published: 2019-07-30T06:04:08.000Z
// Structure last updated: 2024-11-14T01:34:42.000Z
//
// *******************************************************
 ...
 */
export interface Locaties2_ResponseData {
  /**
   * ### 01_NAAM
   *
   * **Type**: Text
   ...
   * **Type**: Point
   */
  the_geom?: { latitude: string; longitude: string; human_address: null | string };
  /**
   * ### UsageId
   *
   * **Type**: Text
...
export const Fields: {
   ...
   * **Type**: Text
   *
   * **Database Column Name**: `location_00`
   */
  Location00: Field("location_00", DataType.Text),
  /**
   * ### LocationRe
   *
   * **Type**: Text
   ...
   */
  TheGeom: Field("the_geom", DataType.Point),
  /**
   * ### UsageId
   *
   * **Type**: Text
...
/**
 * Dataset metadata for **Locaties2**: the available field names, the
...
export const Info = {
  ...
  publication_date: "2019-07-30T06:04:08.000Z",
  metadata_updated_at: "2024-11-14T01:34:42.000Z",
} as const;
 ...
 *
 * -----------------------
 * This generates a SodaQuery for the Locaties dataset.
 *
...
export const RDWQuery = (
  auth: AuthOpts = {},
  opts: Options = {},
): SodaQuery<Locaties2_ResponseData> =>
  createQueryWithDataset<Locaties2_ResponseData>(Info.domain, Info.dataset, auth, {
    ...opts,
 ...
 * - {@link Locaties2.RDWQuery} — a typed {@link SodaQuery} builder
 * - {@link Locaties2.Fields} — the queryable field definitions
 * - {@link Locaties2.Info} — dataset metadata
 *
 * **Category:** Parkeren
 *
 * **Tags:** parkeren
 ...
 * @example
 * ```ts
 * const { data } = await Locaties2.RDWQuery()
 *   .where(Where.like(Locaties2.Fields.N01Naam, "some_value"))
 *   .limit(10)
 *   .execute();
 * ```
 */
export const Locaties2 = {
  RDWQuery,
  Fields,
  Info,
};
